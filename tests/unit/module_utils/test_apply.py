...
tests = [
    ...
    dict(
        last_applied=dict(
            kind="ConfigMap",
            metadata=dict(
                name="foo", annotations=dict(this="one", hello="world")
            ),
            data=dict(one="1", two="2"),
        ),
        desired=dict(
        ...
        expected=dict(
            metadata=dict(annotations=None), data=dict(two=None, three="3")
        ),
    ),
    dict(
        last_applied=dict(
    ...
    dict(
        ...
        expected=dict(
            spec=dict(ports=[dict(port=8080, name="http", protocol='TCP')])
        ),
    ),
    dict(
        last_applied=dict(
        ...
        actual=dict(
            ...
            spec=dict(
                ports=[
                    dict(
                        port=8443, protocol='TCP', name="https", madeup="xyz"
                    ),
                    dict(port=8080, protocol='TCP', name='http'),
                ]
            ),
        ...
        expected=dict(
            spec=dict(
                ports=[
                    dict(madeup=None, port=8443, name="https", protocol='TCP')
                ]
            )
        ),
    ),
